...
function queueService(config) {
  var consume = function () {
    var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(queueName, messageHandler) {
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : config.get('consume.defaults');
      ...
      return _regenerator2.default.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return (0, _connection.getChannel)(queueName, createChannelFactory());
      ...
      return _regenerator2.default.wrap(function _callee9$(_context9) {
        while (1) {
          switch (_context9.prev = _context9.next) {
            case 0:
              _context9.next = 2;
              return (0, _connection.getChannel)(queueName, createChannelFactory(), true);
