...
function queueService(config) {
  var consume = function () {
    var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(queueName, messageHandler) {
      ...
      var channel, consumerOptions, cancelConsuming;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              cancelConsuming = cancelConsumeFactory(channel, consumerOptions.consumerTag);

              (0, _helpers.addCancelConsuming)(queueName, cancelConsuming);
              return _context.abrupt('return', cancelConsuming);
      ...
      return _regenerator2.default.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              _context7.next = 2;
              return (0, _helpers.runAllCancelConsuming)(queueName);
  ...
  var removeIfExists = function () {
      ...
      return _regenerator2.default.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 2:
              return _context8.abrupt('return', safeQueueOperation(queueName, removeQueueFactory(queueName)));
    ...
    return function removeIfExists(_x11) {
      return _ref8.apply(this, arguments);
    };
  }();

  var cancelAllConsuming = function () {
    ...
    return function cancelAllConsuming(_x12) {
  ...
  var purge = function () {
      ...
      return _regenerator2.default.wrap(function _callee10$(_context10) {
        while (1) {
          switch (_context10.prev = _context10.next) {
            case 0:
              return _context10.abrupt('return', safeQueueOperation(queueName, purgeQueueFactory(queueName)));

            case 3:
              channel = _context10.sent;
              return _context10.abrupt('return', purgeQueueFactory(queueName)(channel));
    ...
    return function purge(_x13) {
      return _ref10.apply(this, arguments);
    };
  }();

  var safeQueueOperation = function () {
    var _ref11 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(queueName, queueOperation) {
      ...
      return _regenerator2.default.wrap(function _callee11$(_context11) {
        while (1) {
          switch (_context11.prev = _context11.next) {
            ...
            case 5:
              queueOperationResult = _context11.sent;
              _context11.next = 8;
              return (0, _connection.closeChannel)(channel);

            case 8:
              return _context11.abrupt('return', queueOperationResult);
    ...
    return function safeQueueOperation(_x14, _x15) {
      return _ref11.apply(this, arguments);
    };
  }();

  var getChannelAssert = function () {
    var _ref12 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12(queueName) {
      var channel;
      return _regenerator2.default.wrap(function _callee12$(_context12) {
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 5:
              return _context12.abrupt('return', channel);
    ...
    return function getChannelAssert(_x16) {
      return _ref12.apply(this, arguments);
    };
  }();

  var getChannel = function () {
    var _ref13 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(queueName) {
        ...
        while (1) {
          switch (_context13.prev = _context13.next) {
            ...
            case 2:
              ...
              return _context13.abrupt('return', channel);
    ...
    return function getChannel(_x18) {
  ...
  return Object.freeze({
    ...
    cancelAllConsuming: cancelAllConsuming,
    purge: purge,
